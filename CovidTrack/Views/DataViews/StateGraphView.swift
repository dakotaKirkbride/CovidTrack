...
struct StateGraphView: View {
    ...
    var body: some View {
        ...
        ScrollView(.vertical) {
            VStack {
                HStack{Text(state.name ?? "").font(.largeTitle).bold(); Spacer()}
            ...
            VStack {
                ...
                let lineChartStyle = ChartStyle(backgroundColor: grey, accentColor: Colors.GradientPurple, secondGradientColor: Colors.DarkPurple, textColor: Color.black, legendTextColor: Color.gray, dropShadowColor: Color.gray )
                let chartStyle = ChartStyle(backgroundColor: Color.white, accentColor: Colors.GradientPurple, secondGradientColor: Colors.DarkPurple, textColor: Color.black, legendTextColor: Color.gray, dropShadowColor: Color.gray )
                ...
                BarChartView(data: ChartData(values: dataMngr.weeklyNewCases), title: "New Cases", legend: "Weekly", style: chartStyle, form: ChartForm.extraLarge, valueSpecifier: "%.0f")
                    .padding()
                HStack {
